...
<body>
    ...
    <div class="login" align="center">
        <h3>VTOP Student Login</h3><hr /><br />
        <form id="loogin" method="post" action="http://localhost:8080/first/login">
            <input type="text" name="usid" id="usid" placeholder="Username" /> <br /><br />
            ...
            &nbsp <a href="http://localhost:8080/first/views/faclogin.jsp" style="text-decoration:none;color:#3C8DBC;">Faculty Login</a>
            <br><button type="submit" onclick="return login();">Sign in</button>
