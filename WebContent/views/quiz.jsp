...
<body>
   ...
   <article style="margin-left: 0; width: 96.5%;">
		<h2 align="center"><%= (String)session.getAttribute("csid")%> Quiz</h2>
		   <%
		   String quizSession = (String)session.getAttribute("quiz");
		   if(quizSession == "active"){
			    String csid = (String)session.getAttribute("csid");
			    System.out.println("jsp wali csid:" + csid);
		   		out.println("<p id='quiz-timer'></p>");
                ...
                ResultSet rs = stat.executeQuery(sql);
		   		int qno = 1;
		   		out.println("<form id='quiz-form' action='http://localhost:8080/first/views/quizeval.jsp' method='POST'>");
		   		while(rs.next()){
